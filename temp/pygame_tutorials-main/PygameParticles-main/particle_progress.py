...
class ParticleStar:
	def __init__(self):
		self.particles = []
		self.surface = pygame.image.load('pygame_tutorials-main/PygameParticles-main/star.png').convert_alpha()
...
nyan_surface = pygame.image.load('pygame_tutorials-main/PygameParticles-main/nyan_cat.png').convert_alpha()
